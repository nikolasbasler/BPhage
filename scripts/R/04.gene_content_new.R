...
metabolism_tibble <- phold_predictions_with_extensions %>%
  ...
  mutate(asterisk = ifelse(product %in% genes_of_interest, "*", ""),
         # product = paste0(asterisk, asterisk, product, " ", asterisk, " (", gene_count, ")", asterisk, asterisk)) %>%
         product_label = paste0(asterisk, asterisk, product, " (", gene_count, ")", asterisk, asterisk)) %>%
  select(-asterisk)

# gene_colors <- rev(c("phosphoadenosine phosphosulfate reductase" = "#FFDAB9", 
#                     "chitinase" = "#FFA07A",
#                     "glucosyltransferase" = "#FFC300", 
#                     "levanase" = "#ef8f01", 
#                     "ribosomal protein S6 glutaminyl transferase" = "#66CCCC", 
#                     "PnuC-like nicotinamide mononucleotide transport" = "#8B4513",
#                     "glutamine amidotransferase" = "#4CB3B3", 
#                     "dTDP-4-dehydrorhamnose 3" = "#338080",
#                     "NrdD-like anaerobic ribonucleotide reductase large subunit" = "#2A6666",
#                     "aerobic cobaltochelatase CobT subunit" = "#235050",
#                     "nicotinamide-nucleotide adenylyltransferase" = "#1C3A3A",
#                     "porphyrin biosynthesis" = "#162E2E"))
...
# goi_colors <- rev(c("#FFDAB9", "#FFA07A", "#FFC300", "#ef8f01", "#66CCCC",  "#8B4513", "#4CB3B3", 
#                     "#338080", "#2A6666", "#235050", "#1C3A3A", "#162E2E"))
